...
const Icon: React.FC<IconProps> = ({ name, className = 'w-6 h-6' }) => {
  ...
  const icons: { [key: string]: React.ReactElement } = {
    ...
    keyboard: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.5 1.591L5.25 12.5M9.75 3.104a2.25 2.25 0 00-2.25 2.25v4.126a2.25 2.25 0 00-2.25 2.25L5.25 12.5M9.75 3.104a2.25 2.25 0 012.25 2.25v4.126a2.25 2.25 0 012.25 2.25L18.75 12.5m-9 0h9m-9 0c1.657 0 3-1.343 3-3V6.354c0-1.657-1.343-3-3-3S6.75 4.697 6.75 6.354v3.146c0 1.657 1.343 3 3 3z" />
